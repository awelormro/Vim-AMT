...
# AMT commands   {{{
command! AMTOldfilesv9           AMT_Open_Oldfiles()
command! AMTColorsv9            AMT_Select_Colorscheme()
command! AMTBuffersv9           AMT_Select_Buffer()
command! AMTNerdv9              AMT_insert_nerd_glyph()
command! AMTStartSessionv9      AMT_start_sessions()
command! AMTDeleteSessionsv9    AMT_delete_sessions()
command! AMTSaveSessionv9       AMT_save_session()
command! AMTCloseSessionv9      AMT_Close_session()
command! AMTCursorUp            AMT_Cursor_Up()
command! AMTCursorDown          AMT_cursor_down()
# }}}
# AMT core  󰋑 {{{
